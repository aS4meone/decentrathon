...
export default function DementiaTestResult() {
    ...
    const fetchTestResult = async () => {
      ...
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_BACKEND_URL}/doctor/test-result/${uuid}`,
          {
            headers: {
  ...
  const saveDiagnosis = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/diagnosis/${uuid}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      sections: [
        {
          ...
          children: [
            ...
            ...testResult.recommendation_for_doctor.map(
              (rec) =>
                new Paragraph({
                  text: `• ${rec}`,
                  bullet: { level: 0 },
      ...
      <div className="min-h-screen p-4 sm:p-8">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-4 sm:p-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-[#12375F] mb-4 sm:mb-0">
              Тест не пройден
            </h1>
            <Link
              href="/doctor"
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold mb-2 text-gray-800">
                  Внимание: Тест еще не пройден
                </h2>
                <p className="text-gray-700">
                  Для получения результатов необходимо завершить тест. Вы можете
                  продолжить тестирование прямо сейчас.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-8 mb-8">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-700">
              ...
              <p>
                <span className="font-semibold">Рост:</span> {testResult.height}{" "}
                см
              </p>
              <p>
                <span className="font-semibold">Вес:</span> {testResult.weight}{" "}
                кг
              </p>
              <p>
              ...
              <div className="col-span-1 sm:col-span-2">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  <div className="relative w-full sm:w-auto">
                    ...
                    {isDropdownOpen && (
                      <div className="absolute z-10 w-full sm:w-[300px] mt-1 bg-white border border-gray-300 rounded-md shadow-lg">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <p className="text-lg font-semibold mb-2 text-gray-700 flex flex-row gap-2 items-center justify-between">
                  <span>Шанс развития деменции</span>
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
              <p className="text-xl font-semibold text-gray-800">
                Статус:{" "}
                <span className="text-blue-600">{testResult.status}</span>
              </p>
            </div>
          </div>
