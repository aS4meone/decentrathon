...
export default function DoctorCabinet() {
  ...
  const fetchTestResults = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/doctor/test-results`,
        {
          headers: {
  ...
  const handleCreateTest = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/doctor/create_test_attempt/`,
        {
          method: "POST",
          headers: {
      ...
      <div className="flex h-screen">
        ...
        >
          <div className="flex flex-col h-full">
            <Link
              href="/"
              className="flex items-center gap-2 p-6 bg-[#12375F] text-white"
            >
          ...
          <div className="bg-white shadow-lg rounded-3xl p-4 lg:p-8">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center mb-6 gap-4">
              <div className="relative w-full lg:w-64">
                ...
                />
                <Search
                  className="absolute left-3 top-2.5 text-[#12375F]"
                  size={20}
                />
              </div>
              <button
                    ...
                    .map((result) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-4 whitespace-nowrap flex items-center">
                          ...
                          <Clock
                            size={16}
                            className="ml-4 mr-2 text-[#12375F]"
                          />
