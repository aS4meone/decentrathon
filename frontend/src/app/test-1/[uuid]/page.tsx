            ...
            {showInstruction ? (
                <>
                    ...
                    <button
                        ...
                        className="px-4 py-2 mt-3 font-semibold rounded-lg shadow-md bg-[#12375F] text-white"
                    >
                        Закрыть инструкцию
                    </button>
                </>
                ...
                <>
                    ...
                    <div className="flex justify-center mt-3 space-x-3 max-w-xl mx-auto">
                        <button
                            ...
                            disabled={capturing}
                            className={`px-16 py-2 font-semibold rounded-lg shadow-md ${capturing ? 'bg-gray-400 cursor-not-allowed hidden' : 'bg-[#12375F] text-white'}`}
                        >
                            Start
                        </button>
                        <button
                    ...
                    {results && (
                        <div className="results mt-6 p-4 bg-white rounded-lg shadow-md text-gray-700 max-w-xl mx-auto">
                            <Link href={`/test-2/${uuid}`}
                                  className={`px-4 py-2 mt-4 font-semibold rounded-lg shadow-md ${capturing ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#12375F] text-white'}`}>
                                Далее
                            </Link>
